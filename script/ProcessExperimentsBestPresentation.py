...
def legend(ALGORITHMS,ALG_NAMES) :
    s = "\\\\" +\
        " & \\multicolumn{5}{l}{\\underline{\\textbf{Our Algorithms}}} & \\multicolumn{5}{l}{\\underline{\\textbf{Previous Algorithms}}}\\\\\\\\" +\
        ...
        " & " + ALG_NAMES["bsbc_IE50"] + "&\\multicolumn{8}{l}{- Binary-Search Improved Bin Completion}" 
...
ALGORITHMS = ["ciw","moffitt","bsbc_IE50","bsbcp","snp"]

ALG_NAMES = {"ciw"         : "\\cellcolor{ciwColor} CIW",\
             "ciwlc"       : "\\cellcolor{yellow} LCS",\
             "moffitt"     : "\\cellcolor{mofColor} MOF",\
             "bsbc_IE50"   : "\\cellcolor{ibcColor} IBC",\
             "bsbcp"       : "\\cellcolor{bcpColor} BCP",\
             "rnp"         : "\\cellcolor{gray!15} IRNP",\
             "snp"         : "\\cellcolor{snpColor} SNP"}
